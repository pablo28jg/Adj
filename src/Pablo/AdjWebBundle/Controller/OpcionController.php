...
class OpcionController extends Controller
{
    ...
    public function indexAction()
    {
    	...
    	$source = new Entity('PabloAdjWebBundle:Opcion');
    	$grid = $this->get('grid');
    	...
    	/*if($this->getRequest()->isXmlHttpRequest())
    	 return $grid->getGridResponse('PabloAdministradorBundle:Opcion:index_js.html.twig');
    	else*/
    	return $grid->getGridResponse('PabloAdjWebBundle:Opcion:index.html.twig');
    }
